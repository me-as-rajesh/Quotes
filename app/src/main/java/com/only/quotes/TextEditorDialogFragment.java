...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        VerticalSlideColorPicker colorPickerViewDialog = view.findViewById(R.id.color_picker_view_dialog);

        colorPickerViewDialog.setOnColorChangeListener(selectedColor -> {
